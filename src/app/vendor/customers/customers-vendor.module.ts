...
@NgModule({
  declarations: [ AllComponent, NewComponent, ReturningComponent, AbandonedComponent, EmailSubscribersComponent],
  imports: [
    CommonModule,NgxChartsModule,RouterModule.forChild(routes),
      SharedModule,ConfirmationPopoverModule,ReactiveFormsModule,FormsModule,
      ChartsModule
    ],
    // entryComponents:[ImportCustomersDialogComponent,ExportDialogComponent]
